...
tag_in_world_position = np.array([0.0, -1.6, 1.0])
tag_in_world_direction = -1 * np.array([0.0, 0.0, -1.0])

tag_in_world_transform_matrix = make_transformation_matrix(
...
tag_in_camera_transformation_matrix = make_transformation_matrix(
